    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminAdminRoles", x => new { x.AdminID, x.AdminRoleID });
                    table.ForeignKey(
                        name: "FK_AdminAdminRoles_AdminRoles_AdminRoleID",
                        column: x => x.AdminRoleID,
                        principalTable: "AdminRoles",
                        principalColumn: "AdminRoleID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdminAdminRoles_Admins_AdminID",
                        column: x => x.AdminID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FrameCompanies_Admins_AddedByAdminID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LensID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LensType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lenses_LenseCompanies_LenseCompanyID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lense_company_id = table.Column<int>(type: "int", nullable: false),
                    frame_company_id = table.Column<int>(type: "int", nullable: false),
                    created_by_admin = table.Column<int>(type: "int", nullable: false),
                    updated_by_admin = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Admins_created_by_admin",
                        column: x => x.created_by_admin,
                        principalTable: "Admins",
                        principalColumn: "AdminID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_Admins_updated_by_admin",
                        column: x => x.updated_by_admin,
                        principalTable: "Admins",
                        principalColumn: "AdminID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Products_FrameCompanies_frame_company_id",
                        column: x => x.frame_company_id,
                        principalTable: "FrameCompanies",
                        principalColumn: "FrameCompanyID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_LenseCompanies_lense_company_id",
                        column: x => x.lense_company_id,
                        principalTable: "LenseCompanies",
                        principalColumn: "LenseCompanyID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdminAdminRoles_AdminRoleID",
                table: "AdminAdminRoles",
                column: "AdminRoleID");

            migrationBuilder.CreateIndex(
                name: "IX_FrameCompanies_AddedByAdminID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_created_by_admin",
                table: "Products",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_frame_company_id",
                table: "Products",
                column: "frame_company_id");

            migrationBuilder.CreateIndex(
                name: "IX_Products_lense_company_id",
                table: "Products",
                column: "lense_company_id");

            migrationBuilder.CreateIndex(
                name: "IX_Products_updated_by_admin",
                table: "Products",
